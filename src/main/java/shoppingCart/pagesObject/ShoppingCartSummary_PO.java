...
public class ShoppingCartSummary_PO extends BasePage {
	...
	String ClickDress = ".//*[@id='block_top_menu']/ul/li[2]/a";
	...
	public void AddProducts() {
		...
		for (WebElement item : lists) {
			try {
				...
				fail.failTest("Unable to Add all 5 Dresses");
	...
	public void ShoppingCartIcon() throws InterruptedException {
		...
		try {
			...
			fail.failTest("Unable to Proceed to shopping cart summary page");
		}
	}

	@Step("Verify total price in Cart Summary")
	...
	// Verify total price of each item in cart summary page
